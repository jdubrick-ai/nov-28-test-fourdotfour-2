...
3) Access the `workbench` named `nov-28-test-fourdotfour-2-notebook`.
...
5) In the terminal, run `cd nov-28-test-fourdotfour-2` to navigate to your sample app's directory.
